...
const Data = () => {
  return (
   <div className="home_data">
        <h1 className="home__title">Mayur Kumavat
            <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I am a passionate Full Stack Developer with expertise in building responsive, scalable, and user-friendly web applications.</p>
